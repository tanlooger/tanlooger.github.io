...
reg = /\n(.{1,50}[^？。，IⅡⅢV、“”\d：…（）\n《》！；\-——」])\n/g
reg = /\n(收获文学榜 短篇卷|地上的天空|等下雪|信使|孔雀|水果硬糖|冻土观测段|晚春|跳马|半张脸|喝汤的声音|收获文学榜 中篇卷|以鸟兽之名|制琴师|过往|我父亲的奇想之屋|鬼指根|玫瑰在额头上|星光|月球隐士|仰头一看|梦城|附录 2021收获文学榜榜单|[一二三四五六七八九十〇]{1,3}|[0-9]{1,3})\n/g
